...
class Initializer(
    ...
    private fun migrate1_2() {
        // space
        spaceRepository.findAll().filter { it.version != "2" }.forEach { space ->
        ...
        // users
        userRepository.findAll().filter { it.version != "2" }.forEach { user ->
        ...
        // items
        itemRepository.findAll().filter { it.version != "2" }.forEach { item ->
